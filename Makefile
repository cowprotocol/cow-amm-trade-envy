...
dev-run-pipeline-lastweek-usdcweth:
	uv run src/cow_amm_trade_envy/main.py --network "ethereum" --used_pool_names "['USDC-WETH']" --time_start '2025-01-04 00:00:00' --time_end '2025-01-11 23:59:59'

dev-run-pipeline-lastweek:
	uv run src/cow_amm_trade_envy/main.py --network "ethereum" --time_start '2025-01-05 00:00:00' --time_end '2025-01-11 23:59:59'
...
run-incremental-ingest:
	docker run --env-file .env.prod --network host cow_amm_trade_envy --time_start '2025-01-18 00:00:00'
